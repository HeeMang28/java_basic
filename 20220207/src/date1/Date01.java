...
public class Date01 {
	...
	public static void main(String[] args) {
		...
		//표현되는 양식을 바꿀때는 SimpleDateFormate을 활용합니다.
		// import를 추가해야 합니다.
		SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM"); // 소괄호 사이에 양식을 넣어야 함.
		// 양식은 yyyy는 연도, MM은 월, dd는 일, hh는 시, mm은 분, ss는 초
		String strNow2 = sdf.format(now);//만들어 놓은 Date변수를 sdf양식으로 고쳐서 저장
